...
if __name__ == '__main__':
    ...
    reduce_lr = tf.keras.callbacks.ReduceLROnPlateau(monitor='neg_capacity_train_loss', factor=0.5, patience=4,
                                                     min_lr=1e-12,
                                                     mode='min', verbose=1)
    ...
    reduce_lrTF = tf.keras.callbacks.ReduceLROnPlateau(monitor='neg_capacity_train_loss', factor=0.5, patience=2,
                                                       min_lr=1e-12, mode='min', verbose=1)
