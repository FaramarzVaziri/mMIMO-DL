...
if __name__ == '__main__':
    ...
    obj_dataset_generator_from_generator_class = dataset_generator_from_generator_class(N_b_a, N_b_rf, N_u_a, N_u_rf,
                                                                                        N_s, K, SNR, P, N_c,
                                                                                        N_scatterers,
                                                                                        angular_spread_rad, wavelength,
                                                                                        d, BATCHSIZE, 1, Nsymb,
                                                                                        Ts, fc, c, PHN_innovation_std)
    ...
    print('prints from outside: ', my_dataset)
    print(list(my_dataset.take(1)))
