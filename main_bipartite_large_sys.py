...
# Import classes ///////////////////////////////////////////////////////////////////////////////////////////////////////
from CNN_model import ResNet_model_class # this is the best currently, it has repetitions and no shortcut
...
if __name__ == '__main__':
    ...
    the_model_tx = obj_neural_net_model.resnet_4_large_MIMOFDM_transmitter()
    print('-- TX resnet model is created')
    the_model_rx = obj_neural_net_model.resnet_4_large_MIMOFDM_receiver()
