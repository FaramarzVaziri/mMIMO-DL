...
class dataset_generator_sequential_class:
    ...
    def h_tilde_0_calculation_forall_k(self, H_forall_k, Lambda_B_0_forall_k, Lambda_U_0_forall_k):
    ...
    def dataset_generator(self, mode, phase_noise):
        ...
        H_tilde_0_complex_tmp = []
        for ij in range(self.dataset_size):
            H_tilde_0_complex_tmp.append(self.h_tilde_0_calculation_forall_k(H_complex[ij,:], Lambda_B_0_forall_k_forall_samps[ij,:], Lambda_U_0_forall_k_forall_samps[ij,:]))
        H_tilde_0_complex = tf.stack(H_tilde_0_complex_tmp)
        H_tilde_0 = []
