...
if __name__ == '__main__':
    ...
    # if (input('mixed precision? ') == 'yes'):
    #     mixed_precision.set_global_policy('mixed_float16')

    epochs_pre = 10
    epochs_post = 10
    val_freq_pre = epochs_pre
    val_freq_post = epochs_post
    batch_sizes = [8]
    ...
    for BATCHSIZE in batch_sizes:
        ...
        obj_neural_net_model = ResNet_model_class(N_b_a, N_b_rf, N_u_a, N_u_rf, N_s, K, PTRS_seperation, SNR, P, N_c,
                                                  ...
                                                  convolutional_dilation, subcarrier_strides, N_u_a_strides, N_b_a_strides)

        the_model_tx = obj_neural_net_model.resnet_function_transceiver_large_sys(trainable_csi, trainable_ns, layer_name='TX')
        print('-- TX resnet model is created')
        the_model_rx = obj_neural_net_model.resnet_function_transceiver_large_sys(trainable_csi, trainable_ns, layer_name='RX')
        ...
        obj_capacity_metric = loss_phase_noised_class(N_b_a, N_b_rf, N_u_a, N_u_rf, N_s, K, SNR, P, N_c, N_scatterers, angular_spread_rad, wavelength,
                                                      d, BATCHSIZE, truncation_ratio_keep, Nsymb, 1, 1, 'eval', impl)
