...
from tensorflow.keras.layers import Dense, Conv3D, Reshape, MaxPooling3D, BatchNormalization, Input, Flatten, Dropout, \
    Activation, Add, Conv3DTranspose, Multiply, Lambda, TimeDistributed, ConvLSTM3D
global ofdm_symbol_id
import numpy as np


class IdentityBlock_LSTM_class(tf.keras.Model):  #
    def __init__(self, filters, kernel_size, strides, dilation, trainablity):
        super(IdentityBlock_LSTM_class, self).__init__(name='')
        self.bn0 = TimeDistributed(BatchNormalization())
        self.conv1 = ConvLSTM3D(filters=filters,
...
class Generic_2_ns_4_small_MIMOFDM_CNN_class(tf.keras.Model):  #
    def __init__(self, convolutional_filters, kernels,convolutional_strides, convolutional_dilation, trainablity):
        ...
        # common path
        self.ID_block_common_branch_layer_1 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                       kernel_size=kernels,
                                                                       strides=convolutional_strides,
                                                                       dilation=convolutional_dilation,
                                                                       trainablity=trainablity)
        self.ID_block_common_branch_layer_2 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                       kernel_size=kernels,
                                                                       strides=convolutional_strides,
                                                                       dilation=convolutional_dilation,
                                                                       trainablity=trainablity)
        self.ID_block_common_branch_layer_3 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                       kernel_size=kernels,
                                                                       strides=convolutional_strides,
                                                                       dilation=convolutional_dilation,
                                                                       trainablity=trainablity)

        self.ID_block_common_branch_layer_4 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                       kernel_size=kernels,
                                                                       strides=convolutional_strides,
                                                                       dilation=convolutional_dilation,
                                                                       trainablity=trainablity)
        self.ID_block_common_branch_layer_5 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                       kernel_size=kernels,
                                                                       strides=convolutional_strides,
                                                                       dilation=convolutional_dilation,
                                                                       trainablity=trainablity)
        self.ID_block_common_branch_layer_6 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                       kernel_size=kernels,
                                                                       strides=convolutional_strides,
                                                                       dilation=convolutional_dilation,
                                                                       trainablity=trainablity)
        self.ID_block_common_branch_layer_7 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                       kernel_size=kernels,
                                                                       strides=convolutional_strides,
                                                                       dilation=convolutional_dilation,
                                                                       trainablity=trainablity)
        ...
        # V_D path
        self.ID_block_V_D_branch_layer_1 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        self.ID_block_V_D_branch_layer_2 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        self.ID_block_V_D_branch_layer_3 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        self.ID_block_V_D_branch_layer_4 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        self.ID_block_V_D_branch_layer_5 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        self.ID_block_V_D_branch_layer_6 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        ...
        # V_RF path
        self.ID_block_V_RF_branch_layer_1 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
        self.ID_block_V_RF_branch_layer_2 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
        self.ID_block_V_RF_branch_layer_3 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
        self.ID_block_V_RF_branch_layer_4 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
        self.ID_block_V_RF_branch_layer_5 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
        self.ID_block_V_RF_branch_layer_6 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
...
class Specialized_2_ns_4_small_MIMOFDM_CNN_class(tf.keras.Model):  #
    def __init__(self, convolutional_filters, kernels,convolutional_strides, convolutional_dilation,
        ...
        # V_D path
        self.ID_block_V_D_branch_layer_7 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        self.ID_block_V_D_branch_layer_8 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        self.ID_block_V_D_branch_layer_9 = IdentityBlock_LSTM_class(filters=2,
                                                                    kernel_size=kernels,
                                                                    strides=convolutional_strides,
                                                                    dilation=convolutional_dilation,
                                                                    trainablity=trainablity)
        self.MP_V_D_branch_end = TimeDistributed(MaxPooling3D(pool_size=(1, int(N_u_a / N_b_rf), int(N_b_a / N_s))))
        self.reshaper_V_D = TimeDistributed(Reshape(target_shape=[K, N_b_rf, N_s, 2]))

        # V_RF path
        self.ID_block_V_RF_branch_layer_7 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
        self.ID_block_V_RF_branch_layer_8 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
        self.ID_block_V_RF_branch_layer_9 = IdentityBlock_LSTM_class(filters=1,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
                                                                     dilation=convolutional_dilation,
                                                                     trainablity=trainablity)
        self.MP_V_RF_branch_end = TimeDistributed(MaxPooling3D(pool_size=(K, int(N_u_a / N_b_a), N_b_a)))
...
class Specialized_2_ns_4_large_MIMOFDM_CNN_class(tf.keras.Model):  #
    def __init__(self, convolutional_filters, kernels,convolutional_strides, convolutional_dilation,
        ...
        self.Tconv_V_RF_1 = Conv3DTranspose(filters=convolutional_filters,
                                            kernel_size=(1, N_u_a_strides, N_b_a_strides),
                                            strides=(1, N_u_a_strides, N_b_a_strides),
                                            padding='same')
        self.ID_block_V_RF_branch_layer_7 = IdentityBlock_LSTM_class(filters=convolutional_filters,
                                                                     kernel_size=kernels,
                                                                     strides=convolutional_strides,
...
class ResNet_model_class():
    def __init__(self, N_b_a, N_b_rf, N_u_a, N_u_rf, N_s, K, PTRS_seperation, SNR, P, N_c, N_scatterers,
                 ...
                 d, BATCHSIZE, phase_shift_stddiv, truncation_ratio_keep, Nsymb, sampling_ratio_time_domain_keep, Ts, fc, c, mat_fname,
    ...
    def resnet_4_small_MIMOFDM_transmitter(self):
        ...
        csi = Input(shape=(None, self.K, self.N_u_a, self.N_b_a, 2), batch_size=self.BATCHSIZE)
    ...
    def resnet_4_large_MIMOFDM_transmitter(self):
        kernels = [min(self.K, self.convolutional_kernels),
                   min(self.N_u_a, self.convolutional_kernels),
                   min(self.N_b_a, self.convolutional_kernels)]
        csi = Input(shape=(round(self.Nsymb*self.sampling_ratio_time_domain_keep), self.K, self.N_u_a, self.N_b_a, 2), batch_size=self.BATCHSIZE)
